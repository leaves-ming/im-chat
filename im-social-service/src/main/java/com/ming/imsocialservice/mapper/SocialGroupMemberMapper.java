...
public interface SocialGroupMemberMapper {
    ...
    @Select("""
            ...
            """)
    List<SocialGroupMemberDO> pageActiveMembers(@Param("groupId") Long groupId,
    ...
    @Select("""
            ...
            LIMIT 1
            """)
    SocialGroupMemberDO findActiveMember(@Param("groupId") Long groupId, @Param("userId") Long userId);
